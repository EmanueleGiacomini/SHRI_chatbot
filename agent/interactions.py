...
US_AG_INTERACTION_MAP = {
    ...
    'int3': ['Sto male', 'Non mi sento bene'],
    'int4': ['Non sento gli odori','Ho la febbre','Non sento i sapori','Ho la tosse'],
    ...
    'int9': ['Sono positivo da (1|2|3|4|5|6|7) giorni'],
    ...
    'int14': ['Quali sono alcuni sintomi del (covid|coronavirus)'],
    'int15': ['Quali sono i sintomi lievi del (covid|coronavirus)'],
    'int16': ['Quali sono i sintomi gravi del (covid|coronavirus)'],
