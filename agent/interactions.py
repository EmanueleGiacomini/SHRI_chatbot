...
US_AG_INTERACTION_MAP = {
    ...
    'int16': ['Quali sono i sintomi gravi del (covid|coronavirus)','Dimmi i sintomi lievi del (covid|coronavirus)'],
    'int17': ['Quali sono i paesi più colpiti','Dimmi i paesi più colpiti'],
